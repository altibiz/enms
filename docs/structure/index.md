...
## [`Enms.Data`](docs/structure/data.md)

This project contains the database schema and queries and nothing else. The
`EnmsDbContext` class contains all database tables and the `EnmsDbClient`
...
## [`Enms.Business`](docs/structure/business.md)
...
## [`Enms.Server`](docs/structure/server.md)
...
## [`Enms.Client`](docs/structure/client.md)
...
## [`Enms.Business.Test`](docs/structure/test.md)

This project tests everything in the `Enms.Business` project and mimics its
structure.

## [`Enms.Fake`](docs/structure/fake.md)
