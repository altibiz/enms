...
These entities are accessed through the `EnmsDbContext` class as is described
below:

```plantuml
class EnmsDbContext extends DbContext {
...
This namespace provides classees that represent different types of electrical
