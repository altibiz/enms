...
public static class IQueryableExtensions
{
  ...
  public static IQueryable<T> WithIdFrom<T>(this IQueryable<T> query,
    ICollection<string> ids) where T : IIdentifiableEntity
  {
    return query.Where(MakeWithIdFromExpression<T>(ids));
  }

  public static IEnumerable<T> WithIdFrom<T>(this IEnumerable<T> query,
    ICollection<string> ids) where T : IIdentifiableEntity
  {
