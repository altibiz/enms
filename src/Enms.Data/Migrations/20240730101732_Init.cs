    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    _string_id = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_meters", x => x._string_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_egauge_aggregates", x => new { x.timestamp, x.interval, x.line_id });
                    table.ForeignKey(
                        name: "fk_egauge_aggregates_lines_line_id",
                        column: x => x.line_id,
                        principalTable: "lines",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("TimescaleHypertable", "timestamp,line_id:number_partitions => 2");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    egauge_line_entity_string_id = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_egauge_measurements", x => new { x.timestamp, x.line_id });
                    table.ForeignKey(
                        name: "fk_egauge_measurements_lines_egauge_line_entity_string_id",
                        column: x => x.egauge_line_entity_string_id,
                        principalTable: "lines",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "fk_egauge_measurements_lines_line_id",
                        column: x => x.line_id,
                        principalTable: "lines",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_egauge_aggregates_line_id",
                table: "egauge_aggregates",
                column: "line_id");

            migrationBuilder.CreateIndex(
                name: "ix_egauge_measurements_egauge_line_entity_string_id",
                table: "egauge_measurements",
                column: "egauge_line_entity_string_id");

            migrationBuilder.CreateIndex(
                name: "ix_egauge_measurements_line_id",
                table: "egauge_measurements",
                column: "line_id");
