...
{
    [DbContext(typeof(EnmsDataDbContext))]
    partial class EnmsDataDbContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("Enms.Data.Entities.EgaugeLineEntity", b =>
                {
                    b.HasOne("Enms.Data.Entities.EgaugeMeasurementValidatorEntity", "MeasurementValidator")
                        .WithOne("Line")
                        .HasForeignKey("Enms.Data.Entities.EgaugeLineEntity", "_measurementValidatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
