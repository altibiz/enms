...
namespace Enms.Data.Migrations
{
    ...
    [Migration("20240905030123_Init4")]
    partial class Init4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Enms.Data.Entities.Base.MeterEntity", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("InactivityDuration", "Enms.Data.Entities.Base.MeterEntity.InactivityDuration#TimeSpanEntity", b1 =>
                        {
                            b1.IsRequired();

                            b1.Property<int>("Duration")
                                .HasColumnType("integer")
                                .HasColumnName("inactivity_duration_duration");

                            b1.Property<long>("Multiplier")
                                .HasColumnType("bigint")
                                .HasColumnName("inactivity_duration_multiplier");
                        });
