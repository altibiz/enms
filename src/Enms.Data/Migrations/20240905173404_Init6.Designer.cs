...
namespace Enms.Data.Migrations
{
    ...
    [Migration("20240905173404_Init6")]
    partial class Init6
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Enms.Data.Entities.Base.MeterEntity", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("MaxInactivityPeriod", "Enms.Data.Entities.Base.MeterEntity.MaxInactivityPeriod#TimeSpanEntity", b1 =>
                        {
                            b1.IsRequired();
