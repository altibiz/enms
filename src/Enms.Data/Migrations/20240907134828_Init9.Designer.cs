...
namespace Enms.Data.Migrations
{
    ...
    [Migration("20240907134828_Init9")]
    partial class Init9
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Enms.Data.Entities.Base.MeterEntity", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("MaxMaxInactivityPeriod", "Enms.Data.Entities.Base.MeterEntity.MaxMaxInactivityPeriod#PeriodEntity", b1 =>
                        {
                            b1.IsRequired();

                            b1.Property<DurationEntity>("Duration")
                                .HasColumnType("duration_entity")
                                .HasColumnName("max_max_inactivity_period_duration");

                            b1.Property<long>("Multiplier")
                                .HasColumnType("bigint")
                                .HasColumnName("max_max_inactivity_period_multiplier");
                        });
            ...
            modelBuilder.Entity("Enms.Data.Entities.Joins.NotificationRecipientEntity", b =>
                {
                    b.HasOne("Enms.Data.Entities.RepresentativeEntity", "Recipient")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_notification_recipient_entity_representatives_recipient_id");
                    ...
                    b.HasOne("Enms.Data.Entities.Base.NotificationEntity", "Notification")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_notification_recipient_entity_notification_entity_notificat");
