...
{
    [DbContext(typeof(EnmsDbContext))]
    partial class EnmsDbContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("Enms.Data.Entities.EgaugeMeterEntity", b =>
                {
                    b.HasOne("Enms.Data.Entities.EgaugeMeasurementValidatorEntity", "MeasurementValidator")
                        .WithOne("Meter")
                        .HasForeignKey("Enms.Data.Entities.EgaugeMeterEntity", "_measurementValidatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
